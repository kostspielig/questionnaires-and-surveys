...
<body>
	...
	<form action="login_confirmation.php" method="post">
			<div id="login-box-name" style="margin-top:20px;">Login:</div><div id="login-box-field" style="margin-top:20px;"><input name="q" class="form-login" title="Username" value="" size="30" maxlength="2048" /></div>
			...
			<br />
			<br />
			  <input type="submit" value="Submit" width="103" height="42" style="margin-left:90px;"/>
