...
$objPHPExcel->getActiveSheet()->SetCellValue('B7', '20');
$objPHPExcel->getActiveSheet()->SetCellValue('B8', '800');
$objPHPExcel->getActiveSheet()->SetCellValue('B16', 'My Survey');

echo date('H:i:s') . " Write to Excel2007 format\n";
$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
$objWriter->save("Experiment A.xlsx");
